      ...
      <div className={cn("flex items-center gap-2", "transition-all duration-300 ease-out")}>
        <Sun
          className={cn(
            ...
            theme === "dark" ? "text-zinc-300 group-hover:text-zinc-100" : "text-amber-500 group-hover:text-amber-600",
            "group-active:scale-95",
          )}
        />
        {showLabel && (
          <span className={cn("capitalize font-medium relative", "transition-opacity duration-300 ease-out")}>
            <span
              className={cn(
                "absolute inset-0",

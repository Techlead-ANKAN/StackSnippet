...
export default function BeamsBackground({ className, intensity = "strong", children }: BeamsBackgroundProps) {
  ...
  return (
    <div className={cn("relative min-h-screen w-full overflow-hidden bg-neutral-100 dark:bg-black", className)}>
      <canvas ref={canvasRef} className="absolute inset-0" style={{ filter: "blur(15px)" }} />
      <motion.div
        className="absolute inset-0 bg-neutral-900/5 dark:bg-black/20"
        animate={{
